...
if [[ "$unamestr" == 'Linux' ]]; then
  #############
  ./sfleta_cat -b input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  #############
  ./sfleta_cat -n input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  #############
  ./sfleta_cat -b -e input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -b -n input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -b -s input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -b -t input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -e -n input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -n -s input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -n -t input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -b -e -n input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -b -e -s input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -b -e -t input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -e -n -s input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -e -n -t input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -n -s -t input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -s -t -b input.txt input3.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -b -e -n -s input.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -b -e -n -t input.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -b -e -s -t input.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -b -n -s -t input.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -e -n -s -t input.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -b -e -n -s -t input.txt input2.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -b input.txt input2.txt input.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -bte input.txt input2.txt input.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -btens input2.txt input.txt input3.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat --number-nonblank --squeeze-blank input.txt input2.txt input3.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -t nonreaderble.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -e nonreaderble.txt > sfleta_cat_out
  ...
  ##############
  ./sfleta_cat -be nonreaderble.txt input.txt > sfleta_cat_out
